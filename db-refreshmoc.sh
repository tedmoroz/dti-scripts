...
select SYSTEM_NAME in ent-mocailxpbs01 arlxpbs01 ent-mocbslxpbs01 cclxpbs01 mclxpbs01 mclxpbs02 mjlxpbs01 ndlxpbs01 rrlxpbs01 sslxpbs01 sulxpbs01 vslxpbs01 wtlxpbs01 knlxpbs01 eclxpbs01 Exit 
...
do
	case $SYSTEM_NAME in
		arlxpbs01 | rrlxpbs01 | sslxpbs01 | sulxpbs01 | knlxpbs01 | eclxpbs01 | mclxpbs01 | mclxpbs02)
			...
			#
		ent-mocailxpbs01 | wtlxpbs01 | mjlxpbs01)
			case $SYSTEM_NAME in
                                wtlxpbs01)
                                        ZONE="central";;
                                ent-mocailxpbs01)
...
#
		...
		*)
			echo "Invalid server choice. Please rerun the script and choose a valid server."
                        echo "1) ent-mocailxpbs01 2) arlxpbs01 3) ent-mocbslxpbs01 4) cclxpbs01 5) ndlxpbs01"
