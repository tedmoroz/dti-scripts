...
do
	case $SYSTEM_NAME in
		ailxpbs01 | arlxpbs01 | bslxpbs01 | cclxpbs01  | eclxpbs01 | knlxpbs01 | mclxpbs01 | mclxpbs02 | ndlxpbs01 | rrlxpbs01 | sslxpbs01 | sulxpbs01 | vslxpbs01 | wtlxpbs01)
	       		case $SYSTEM_NAME in	
				arlxpbs01 | sslxpbs01 | mclxpbs01 | mclxpbs02 | eclxpbs01 | cclxpbs01 | wtlxpbs01)
					ZONE="central";;
				rrlxpbs01 | bslxpbs01 | vslxpbs01)
					ZONE="pacific";;
				sulxpbs01 | ailxpbs01 | knlxpbs01 | ndlxpbs01)
					ZONE="eastern";;
			esac	
		...
		*)
			...
			echo "11) eclxpbs01 12) knlxpbs01 13) mclxpbs01 14) mclxpbs02 "
                        exit;;
